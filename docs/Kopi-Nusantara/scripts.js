...
document
  .querySelector(".show-more-habits")
...
document
  .querySelector(".show-more-consumtionpatterns")
  .addEventListener("click", function () {
...
document
  .querySelector(".show-more-technique")
  .addEventListener("click", function () {
    var details = document.querySelector("#technique .content-details");
    var showMoreText = this;

    details.classList.toggle("show");
    showMoreText.textContent = details.classList.contains("show")
      ? "Sembunyikan"
...
function fetchComments() {
  fetch(
    "https://script.google.com/macros/s/AKfycbzZyC0l_LvDOI_u7ZbIWc1D_ujT89RY4WqMXLzcKsdnfT_y8YnDpdLlV1EioJScr_Ul1w/exec"
  )
